	...
	public function _remap($action, $params = array())
	{
		...
		else
		{
			...
			{	// TODO : contrôler la validité du second paramètre (mois de la fiche à modifier)
				...
				$this->a_visiteur->mesFiches($idUtilisateur, "La fiche $mois a été signée. <br/>Pensez à envoyer vos justificatifs afin qu'elle soit traitée par le service comptable rapidement.");
			}
			...
			{	// TODO : conrôler que l'obtention des données postées ne rend pas d'erreurs
				...
				// ... et on revient en modification de la fiche
				$this->a_visiteur->modFiche($idUtilisateur, $mois, 'Ligne "Hors forfait" ajoutée ...');				
			}
