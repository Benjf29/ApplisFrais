...
class A_comptable extends CI_Model {
	...
	*/
	...
	public function mesFichesCon ($idVisiteur, $message=null)
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
	
	$idVisiteur = $this->session->userdata('idUser');
	
	$data['notify'] = $message;
	$data['mesFiches'] = $this->dataAccess->getFichesCon($idVisiteur);
	$this->templates->load('t_comptable', 'v_conMesFiches', $data);
	}
	
	public function touteFiches ($idVisiteur, $message=null)
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
	...
	*/
	...
	$this->templates->load('t_comptable', 'v_conRefuFicheCom');
	}
	/**
	...
	*/
	...
	public function paiementFiche ($idVisiteur, $message=null)
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
