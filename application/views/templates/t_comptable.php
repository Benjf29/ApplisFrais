		...
		<div id="page">
			...
			<div id="menuGauche">
				...
				<ul id="menuList">
					...
					<li>
						<?php echo anchor('c_comptable/mesFichesCon', 'Fiches en cours', 'title="Consultation de mes fiches de frais"'); ?>
					</li>
					<li>
					
					<?php echo anchor('c_comptable/touteFiche', 'Voir toutes les fiches', 'title="Afficher la liste de toutes les fiches"'); ?>
					</li>
					<li>
					
					<?php echo anchor('c_comptable/paiementFiche', 'Voir les suivis de paiement', 'title="Afficher la liste de toutes les fiches en suivit de paiement"'); ?>
					</li>
					<li>
